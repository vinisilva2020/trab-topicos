...
<body>
            ...
            <div class="col-md-8 mt-3 mx-auto">
                <div class="card bg-transparent shadow">
                    <div class="card-header bg-transparent">
                        <h5 class=" card-title text-center">Editar contatos</h5>
                    </div>
                    <div class="card-body">
  ...
  <div class="mb-3">
    ...
    <input type="email" name="email" class="form-control" value="<?php echo $banco['email']; ?>"  aria-describedby="emailHelp">
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Nome</label>
    <input type="text" name="nome" class="form-control" value="<?php echo $banco['nome'] ?>">
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Telefone</label>
    <input type="text" name="telefone" class=" telefone form-control" value="<?php echo $banco['telefone'] ?> id="exampleInputPassword1">
  </div>
  <button type="submit" name="cadastrar-contato" class="btn btn-outline-success">Salvar alteração</button>
</form>
                    </div>
                </div>
            </div>
